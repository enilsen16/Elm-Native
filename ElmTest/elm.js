...
Elm.NativeUi.make = function (_elm) {
   ...
   return _elm.NativeUi.values = {_op: _op,node: node,string: string,style: style,on: on,property: property};
};
Elm.NativeUi = Elm.NativeUi || {};
Elm.NativeUi.Elements = Elm.NativeUi.Elements || {};
Elm.NativeUi.Elements.make = function (_elm) {
   "use strict";
   _elm.NativeUi = _elm.NativeUi || {};
   _elm.NativeUi.Elements = _elm.NativeUi.Elements || {};
   if (_elm.NativeUi.Elements.values) return _elm.NativeUi.Elements.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = $NativeUi.node("View");
   var toolbar = $NativeUi.node("Toolbar");
   var textInput = $NativeUi.node("TextInput");
   var tabBar = $NativeUi.node("TabBar");
   var $switch = $NativeUi.node("Switch");
   var statusBar = $NativeUi.node("StatusBar");
   var slider = $NativeUi.node("Slider");
   var segmentedControl = $NativeUi.node("SegmentedControl");
   var scrollView = $NativeUi.node("ScrollView");
   var refreshControl = $NativeUi.node("RefreshControl");
   var progressView = $NativeUi.node("ProgressView");
   var progressBar = $NativeUi.node("ProgressBar");
   var picker = $NativeUi.node("Picker");
   var mapView = $NativeUi.node("MapView");
   var activityIndicator = $NativeUi.node("ActivityIndicator");
   var image = $NativeUi.node("Image");
   var text = $NativeUi.node("Text");
   return _elm.NativeUi.Elements.values = {_op: _op
                                          ,text: text
                                          ,image: image
...
Elm.NativeUi = Elm.NativeUi || {};
Elm.NativeUi.Handlers = Elm.NativeUi.Handlers || {};
Elm.NativeUi.Handlers.make = function (_elm) {
   "use strict";
   _elm.NativeUi = _elm.NativeUi || {};
   _elm.NativeUi.Handlers = _elm.NativeUi.Handlers || {};
   if (_elm.NativeUi.Handlers.values) return _elm.NativeUi.Handlers.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var onMoveShouldSetResponderCapture = F2(function (address,action) {
      return A3($NativeUi.on,"MoveShouldSetResponderCapture",$Json$Decode.value,function (_p0) {    return A2($Signal.message,address,action);});
   });
   var onMoveShouldSetResponder = F2(function (address,action) {
      return A3($NativeUi.on,"MoveShouldSetResponder",$Json$Decode.value,function (_p1) {    return A2($Signal.message,address,action);});
   });
   var onStartShouldSetResponderCapture = F2(function (address,action) {
      return A3($NativeUi.on,"StartShouldSetResponderCapture",$Json$Decode.value,function (_p2) {    return A2($Signal.message,address,action);});
   });
   var onStartShouldSetResponder = F2(function (address,action) {
      return A3($NativeUi.on,"StartShouldSetResponder",$Json$Decode.value,function (_p3) {    return A2($Signal.message,address,action);});
   });
   var onResponderTerminationRequest = F2(function (address,action) {
      return A3($NativeUi.on,"ResponderTerminationRequest",$Json$Decode.value,function (_p4) {    return A2($Signal.message,address,action);});
   });
   var onResponderTerminate = F2(function (address,action) {
      return A3($NativeUi.on,"ResponderTerminate",$Json$Decode.value,function (_p5) {    return A2($Signal.message,address,action);});
   });
   var onResponderRelease = F2(function (address,action) {
      return A3($NativeUi.on,"ResponderRelease",$Json$Decode.value,function (_p6) {    return A2($Signal.message,address,action);});
   });
   var onResponderReject = F2(function (address,action) {
      return A3($NativeUi.on,"ResponderReject",$Json$Decode.value,function (_p7) {    return A2($Signal.message,address,action);});
   });
   var onResponderMove = F2(function (address,action) {
      return A3($NativeUi.on,"ResponderMove",$Json$Decode.value,function (_p8) {    return A2($Signal.message,address,action);});
   });
   var onResponderGrant = F2(function (address,action) {
      return A3($NativeUi.on,"ResponderGrant",$Json$Decode.value,function (_p9) {    return A2($Signal.message,address,action);});
   });
   var onMagicTap = F2(function (address,action) {
      return A3($NativeUi.on,"MagicTap",$Json$Decode.value,function (_p10) {    return A2($Signal.message,address,action);});
   });
   var onAccessibilityTap = F2(function (address,action) {
      return A3($NativeUi.on,"AccessibilityTap",$Json$Decode.value,function (_p11) {    return A2($Signal.message,address,action);});
   });
   var onIconClicked = F2(function (address,action) {
      return A3($NativeUi.on,"IconClicked",$Json$Decode.value,function (_p12) {    return A2($Signal.message,address,action);});
   });
   var onActionSelected = F2(function (address,action) {
      return A3($NativeUi.on,"ActionSelected",$Json$Decode.value,function (_p13) {    return A2($Signal.message,address,action);});
   });
   var onKeyPress = F2(function (address,action) {
      return A3($NativeUi.on,"KeyPress",$Json$Decode.value,function (_p14) {    return A2($Signal.message,address,action);});
   });
   var onSubmitEditing = F2(function (address,action) {
      return A3($NativeUi.on,"SubmitEditing",$Json$Decode.value,function (_p15) {    return A2($Signal.message,address,action);});
   });
   var onSelectionChange = F2(function (address,action) {
      return A3($NativeUi.on,"SelectionChange",$Json$Decode.value,function (_p16) {    return A2($Signal.message,address,action);});
   });
   var onEndEditing = F2(function (address,action) {
      return A3($NativeUi.on,"EndEditing",$Json$Decode.value,function (_p17) {    return A2($Signal.message,address,action);});
   });
   var onChangeText = F2(function (address,stringToAction) {
      return A3($NativeUi.on,"ChangeText",$Json$Decode.string,function (text) {    return A2($Signal.message,address,stringToAction(text));});
   });
   var onFocus = F2(function (address,action) {
      return A3($NativeUi.on,"Focus",$Json$Decode.value,function (_p18) {    return A2($Signal.message,address,action);});
   });
   var onBlur = F2(function (address,action) {
      return A3($NativeUi.on,"Blur",$Json$Decode.value,function (_p19) {    return A2($Signal.message,address,action);});
   });
   var onSwitchValueChange = F2(function (address,intToAction) {
      return A3($NativeUi.on,"SwitchValueChange",$Json$Decode.$int,function (value) {    return A2($Signal.message,address,intToAction(value));});
   });
   var onSlidingComplete = F2(function (address,action) {
      return A3($NativeUi.on,"SlidingComplete",$Json$Decode.value,function (_p20) {    return A2($Signal.message,address,action);});
   });
   var onSliderValueChange = F2(function (address,floatToAction) {
      return A3($NativeUi.on,"SliderValueChange",$Json$Decode.$float,function (value) {    return A2($Signal.message,address,floatToAction(value));});
   });
   var onChange = F2(function (address,action) {
      return A3($NativeUi.on,"Change",$Json$Decode.value,function (_p21) {    return A2($Signal.message,address,action);});
   });
   var onSegmentedControlValueChange = F2(function (address,intToAction) {
      return A3($NativeUi.on,"SegmentedControlValueChange",$Json$Decode.$int,function (value) {    return A2($Signal.message,address,intToAction(value));});
   });
   var onContentSizeChange = F2(function (address,action) {
      return A3($NativeUi.on,"ContentSizeChange",$Json$Decode.value,function (_p22) {    return A2($Signal.message,address,action);});
   });
   var onScrollAnimationEnd = F2(function (address,action) {
      return A3($NativeUi.on,"ScrollAnimationEnd",$Json$Decode.value,function (_p23) {    return A2($Signal.message,address,action);});
   });
   var onScroll = F2(function (address,action) {
      return A3($NativeUi.on,"Scroll",$Json$Decode.value,function (_p24) {    return A2($Signal.message,address,action);});
   });
   var onRefresh = F2(function (address,action) {
      return A3($NativeUi.on,"Refresh",$Json$Decode.value,function (_p25) {    return A2($Signal.message,address,action);});
   });
   var onPickerValueChange = F2(function (address,stringToAction) {
      return A3($NativeUi.on,"PickerValueChange",$Json$Decode.string,function (value) {    return A2($Signal.message,address,stringToAction(value));});
   });
   var onAnnotationPress = F2(function (address,action) {
      return A3($NativeUi.on,"AnnotationPress",$Json$Decode.value,function (_p26) {    return A2($Signal.message,address,action);});
   });
   var onRegionChangeComplete = F2(function (address,action) {
      return A3($NativeUi.on,"RegionChangeComplete",$Json$Decode.value,function (_p27) {    return A2($Signal.message,address,action);});
   });
   var onRegionChange = F2(function (address,action) {
      return A3($NativeUi.on,"RegionChange",$Json$Decode.value,function (_p28) {    return A2($Signal.message,address,action);});
   });
   var onLoadEnd = F2(function (address,action) {
      return A3($NativeUi.on,"LoadEnd",$Json$Decode.value,function (_p29) {    return A2($Signal.message,address,action);});
   });
   var onLoad = F2(function (address,action) {
      return A3($NativeUi.on,"Load",$Json$Decode.value,function (_p30) {    return A2($Signal.message,address,action);});
   });
   var onError = F2(function (address,action) {
      return A3($NativeUi.on,"Error",$Json$Decode.value,function (_p31) {    return A2($Signal.message,address,action);});
   });
   var onProgress = F2(function (address,action) {
      return A3($NativeUi.on,"Progress",$Json$Decode.value,function (_p32) {    return A2($Signal.message,address,action);});
   });
   var onLoadStart = F2(function (address,action) {
      return A3($NativeUi.on,"LoadStart",$Json$Decode.value,function (_p33) {    return A2($Signal.message,address,action);});
   });
   var onPress = F2(function (address,action) {
      return A3($NativeUi.on,"Press",$Json$Decode.value,function (_p34) {    return A2($Signal.message,address,action);});
   });
   var onLayout = F2(function (address,action) {
      return A3($NativeUi.on,"Layout",$Json$Decode.value,function (_p35) {    return A2($Signal.message,address,action);});
   });
   return _elm.NativeUi.Handlers.values = {_op: _op
                                          ,onLayout: onLayout
                                          ,onPress: onPress
                                          ...
                                          ,onSegmentedControlValueChange: onSegmentedControlValueChange
                                          ,onChange: onChange
   ...
   var start = function (config) {
      var normalUpdate = F2(function (maybeAction,model) {
         ...
         if (_p0.ctor === "Just") {
               ...
               return _U.crashCase("NativeUi.NativeApp",{start: {line: 41,column: 7},end: {line: 46,column: 50}},_p0)("This should never happen.");
            }
      });
...
Elm.NativeUi = Elm.NativeUi || {};
Elm.NativeUi.Properties = Elm.NativeUi.Properties || {};
Elm.NativeUi.Properties.make = function (_elm) {
   "use strict";
   _elm.NativeUi = _elm.NativeUi || {};
   _elm.NativeUi.Properties = _elm.NativeUi.Properties || {};
   if (_elm.NativeUi.Properties.values) return _elm.NativeUi.Properties.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Encode = Elm.Json.Encode.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var needsOffscreenAlphaCompositing = function (val) {    return A2($NativeUi.property,"needsOffscreenAlphaCompositing",$Json$Encode.bool(val));};
   var collapsable = function (val) {    return A2($NativeUi.property,"collapsable",$Json$Encode.bool(val));};
   var shouldRasterizeIOS = function (val) {    return A2($NativeUi.property,"shouldRasterizeIOS",$Json$Encode.bool(val));};
   var renderToHardwareTextureAndroid = function (val) {    return A2($NativeUi.property,"renderToHardwareTextureAndroid",$Json$Encode.bool(val));};
   var pointerEvents = function (val) {
      var stringValue = function () {
         var _p0 = val;
         switch (_p0.ctor)
         {case "ViewPointerEventsBoxNone": return "box-none";
            case "ViewPointerEventsNone": return "none";
            case "ViewPointerEventsBoxOnly": return "box-only";
            default: return "auto";}
      }();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"pointerEvents",jsonValue);
   };
   var ViewPointerEventsAuto = {ctor: "ViewPointerEventsAuto"};
   var ViewPointerEventsBoxOnly = {ctor: "ViewPointerEventsBoxOnly"};
   var ViewPointerEventsNone = {ctor: "ViewPointerEventsNone"};
   var ViewPointerEventsBoxNone = {ctor: "ViewPointerEventsBoxNone"};
   var importantForAccessibility = function (val) {
      var stringValue = function () {
         var _p1 = val;
         switch (_p1.ctor)
         {case "ViewImportantForAccessibilityAuto": return "auto";
            case "ViewImportantForAccessibilityYes": return "yes";
            case "ViewImportantForAccessibilityNo": return "no";
            default: return "no-hide-descendants";}
      }();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"importantForAccessibility",jsonValue);
   };
   var ViewImportantForAccessibilityNoHideDescendants = {ctor: "ViewImportantForAccessibilityNoHideDescendants"};
   var ViewImportantForAccessibilityNo = {ctor: "ViewImportantForAccessibilityNo"};
   var ViewImportantForAccessibilityYes = {ctor: "ViewImportantForAccessibilityYes"};
   var ViewImportantForAccessibilityAuto = {ctor: "ViewImportantForAccessibilityAuto"};
   var accessibilityLiveRegion = function (val) {
      var stringValue = function () {
         var _p2 = val;
         switch (_p2.ctor)
         {case "ViewAccessibilityLiveRegionNone": return "none";
            case "ViewAccessibilityLiveRegionPolite": return "polite";
            default: return "assertive";}
      }();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"accessibilityLiveRegion",jsonValue);
   };
   var ViewAccessibilityLiveRegionAssertive = {ctor: "ViewAccessibilityLiveRegionAssertive"};
   var ViewAccessibilityLiveRegionPolite = {ctor: "ViewAccessibilityLiveRegionPolite"};
   var ViewAccessibilityLiveRegionNone = {ctor: "ViewAccessibilityLiveRegionNone"};
   var rtl = function (val) {    return A2($NativeUi.property,"rtl",$Json$Encode.bool(val));};
   var contentInsetEnd = function (val) {    return A2($NativeUi.property,"contentInsetEnd",$Json$Encode.$float(val));};
   var contentInsetStart = function (val) {    return A2($NativeUi.property,"contentInsetStart",$Json$Encode.$float(val));};
   var subtitle = function (val) {    return A2($NativeUi.property,"subtitle",$Json$Encode.string(val));};
   var underlineColorAndroid = function (val) {    return A2($NativeUi.property,"underlineColorAndroid",$Json$Encode.string(val));};
   var blurOnSubmit = function (val) {    return A2($NativeUi.property,"blurOnSubmit",$Json$Encode.bool(val));};
   var selectTextOnFocus = function (val) {    return A2($NativeUi.property,"selectTextOnFocus",$Json$Encode.bool(val));};
   var clearTextOnFocus = function (val) {    return A2($NativeUi.property,"clearTextOnFocus",$Json$Encode.bool(val));};
   var clearButtonMode = function (val) {
      var stringValue = function () {
         var _p3 = val;
         switch (_p3.ctor)
         {case "TextInputClearButtonModeNever": return "never";
            case "TextInputClearButtonModeWhileEditing": return "while-editing";
            case "TextInputClearButtonModeUnlessEditing": return "unless-editing";
            default: return "always";}
      }();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"clearButtonMode",jsonValue);
   };
   var TextInputClearButtonModeAlways = {ctor: "TextInputClearButtonModeAlways"};
   var TextInputClearButtonModeUnlessEditing = {ctor: "TextInputClearButtonModeUnlessEditing"};
   var TextInputClearButtonModeWhileEditing = {ctor: "TextInputClearButtonModeWhileEditing"};
   var TextInputClearButtonModeNever = {ctor: "TextInputClearButtonModeNever"};
   var defaultValue = function (val) {    return A2($NativeUi.property,"defaultValue",$Json$Encode.string(val));};
   var value = function (val) {    return A2($NativeUi.property,"value",$Json$Encode.string(val));};
   var selectionColor = function (val) {    return A2($NativeUi.property,"selectionColor",$Json$Encode.string(val));};
   var secureTextEntry = function (val) {    return A2($NativeUi.property,"secureTextEntry",$Json$Encode.bool(val));};
   var placeholderTextColor = function (val) {    return A2($NativeUi.property,"placeholderTextColor",$Json$Encode.string(val));};
   var placeholder = function (val) {    return A2($NativeUi.property,"placeholder",$Json$Encode.string(val));};
   var multiline = function (val) {    return A2($NativeUi.property,"multiline",$Json$Encode.bool(val));};
   var enablesReturnKeyAutomatically = function (val) {    return A2($NativeUi.property,"enablesReturnKeyAutomatically",$Json$Encode.bool(val));};
   var maxLength = function (val) {    return A2($NativeUi.property,"maxLength",$Json$Encode.$float(val));};
   var returnKeyType = function (val) {
      var stringValue = function () {
         var _p4 = val;
         switch (_p4.ctor)
         {case "TextInputReturnKeyTypeDefault": return "default";
            case "TextInputReturnKeyTypeGo": return "go";
            case "TextInputReturnKeyTypeGoogle": return "google";
            case "TextInputReturnKeyTypeJoin": return "join";
            case "TextInputReturnKeyTypeNext": return "next";
            case "TextInputReturnKeyTypeRoute": return "route";
            case "TextInputReturnKeyTypeSearch": return "search";
            case "TextInputReturnKeyTypeSend": return "send";
            case "TextInputReturnKeyTypeYahoo": return "yahoo";
            case "TextInputReturnKeyTypeDone": return "done";
            default: return "emergency-call";}
      }();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"returnKeyType",jsonValue);
   };
   var TextInputReturnKeyTypeEmergencyCall = {ctor: "TextInputReturnKeyTypeEmergencyCall"};
   var TextInputReturnKeyTypeDone = {ctor: "TextInputReturnKeyTypeDone"};
   var TextInputReturnKeyTypeYahoo = {ctor: "TextInputReturnKeyTypeYahoo"};
   var TextInputReturnKeyTypeSend = {ctor: "TextInputReturnKeyTypeSend"};
   var TextInputReturnKeyTypeSearch = {ctor: "TextInputReturnKeyTypeSearch"};
   var TextInputReturnKeyTypeRoute = {ctor: "TextInputReturnKeyTypeRoute"};
   var TextInputReturnKeyTypeNext = {ctor: "TextInputReturnKeyTypeNext"};
   var TextInputReturnKeyTypeJoin = {ctor: "TextInputReturnKeyTypeJoin"};
   var TextInputReturnKeyTypeGoogle = {ctor: "TextInputReturnKeyTypeGoogle"};
   var TextInputReturnKeyTypeGo = {ctor: "TextInputReturnKeyTypeGo"};
   var TextInputReturnKeyTypeDefault = {ctor: "TextInputReturnKeyTypeDefault"};
   var keyboardAppearance = function (val) {
      var stringValue = function () {
         var _p5 = val;
         switch (_p5.ctor)
         {case "TextInputKeyboardAppearanceDefault": return "default";
            case "TextInputKeyboardAppearanceLight": return "light";
            default: return "dark";}
      }();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"keyboardAppearance",jsonValue);
   };
   var TextInputKeyboardAppearanceDark = {ctor: "TextInputKeyboardAppearanceDark"};
   var TextInputKeyboardAppearanceLight = {ctor: "TextInputKeyboardAppearanceLight"};
   var TextInputKeyboardAppearanceDefault = {ctor: "TextInputKeyboardAppearanceDefault"};
   var keyboardType = function (val) {
      var stringValue = function () {
         var _p6 = val;
         switch (_p6.ctor)
         {case "TextInputKeyboardTypeDefault": return "default";
            case "TextInputKeyboardTypeEmailAddress": return "email-address";
            case "TextInputKeyboardTypeNumeric": return "numeric";
            case "TextInputKeyboardTypePhonePad": return "phone-pad";
            case "TextInputKeyboardTypeAsciiCapable": return "ascii-capable";
            case "TextInputKeyboardTypeNumbersAndPunctuation": return "numbers-and-punctuation";
            case "TextInputKeyboardTypeUrl": return "url";
            case "TextInputKeyboardTypeNumberPad": return "number-pad";
            case "TextInputKeyboardTypeNamePhonePad": return "name-phone-pad";
            case "TextInputKeyboardTypeDecimalPad": return "decimal-pad";
            case "TextInputKeyboardTypeTwitter": return "twitter";
            default: return "web-search";}
      }();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"keyboardType",jsonValue);
   };
   var TextInputKeyboardTypeWebSearch = {ctor: "TextInputKeyboardTypeWebSearch"};
   var TextInputKeyboardTypeTwitter = {ctor: "TextInputKeyboardTypeTwitter"};
   var TextInputKeyboardTypeDecimalPad = {ctor: "TextInputKeyboardTypeDecimalPad"};
   var TextInputKeyboardTypeNamePhonePad = {ctor: "TextInputKeyboardTypeNamePhonePad"};
   var TextInputKeyboardTypeNumberPad = {ctor: "TextInputKeyboardTypeNumberPad"};
   var TextInputKeyboardTypeUrl = {ctor: "TextInputKeyboardTypeUrl"};
   var TextInputKeyboardTypeNumbersAndPunctuation = {ctor: "TextInputKeyboardTypeNumbersAndPunctuation"};
   var TextInputKeyboardTypeAsciiCapable = {ctor: "TextInputKeyboardTypeAsciiCapable"};
   var TextInputKeyboardTypePhonePad = {ctor: "TextInputKeyboardTypePhonePad"};
   var TextInputKeyboardTypeNumeric = {ctor: "TextInputKeyboardTypeNumeric"};
   var TextInputKeyboardTypeEmailAddress = {ctor: "TextInputKeyboardTypeEmailAddress"};
   var TextInputKeyboardTypeDefault = {ctor: "TextInputKeyboardTypeDefault"};
   var editable = function (val) {    return A2($NativeUi.property,"editable",$Json$Encode.bool(val));};
   var autoFocus = function (val) {    return A2($NativeUi.property,"autoFocus",$Json$Encode.bool(val));};
   var autoCorrect = function (val) {    return A2($NativeUi.property,"autoCorrect",$Json$Encode.bool(val));};
   var autoCapitalize = function (val) {
      var stringValue = function () {
         var _p7 = val;
         switch (_p7.ctor)
         {case "TextInputAutoCapitalizeNone": return "none";
            case "TextInputAutoCapitalizeSentences": return "sentences";
            case "TextInputAutoCapitalizeWords": return "words";
            default: return "characters";}
      }();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"autoCapitalize",jsonValue);
   };
   var TextInputAutoCapitalizeCharacters = {ctor: "TextInputAutoCapitalizeCharacters"};
   var TextInputAutoCapitalizeWords = {ctor: "TextInputAutoCapitalizeWords"};
   var TextInputAutoCapitalizeSentences = {ctor: "TextInputAutoCapitalizeSentences"};
   var TextInputAutoCapitalizeNone = {ctor: "TextInputAutoCapitalizeNone"};
   var showHideTransition = function (val) {
      var stringValue = function () {    var _p8 = val;if (_p8.ctor === "StatusBarShowHideTransitionFade") {    return "fade";} else {    return "slide";}}();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"showHideTransition",jsonValue);
   };
   var StatusBarShowHideTransitionSlide = {ctor: "StatusBarShowHideTransitionSlide"};
   var StatusBarShowHideTransitionFade = {ctor: "StatusBarShowHideTransitionFade"};
   var networkActivityIndicatorVisible = function (val) {    return A2($NativeUi.property,"networkActivityIndicatorVisible",$Json$Encode.bool(val));};
   var barStyle = function (val) {
      var stringValue = function () {
         var _p9 = val;
      ...
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"barStyle",jsonValue);
   };
   var StatusBarBarStyleLightContent = {ctor: "StatusBarBarStyleLightContent"};
   var StatusBarBarStyleDefault = {ctor: "StatusBarBarStyleDefault"};
   var translucent = function (val) {    return A2($NativeUi.property,"translucent",$Json$Encode.bool(val));};
   var animated = function (val) {    return A2($NativeUi.property,"animated",$Json$Encode.bool(val));};
   var hidden = function (val) {    return A2($NativeUi.property,"hidden",$Json$Encode.bool(val));};
   var disabled = function (val) {    return A2($NativeUi.property,"disabled",$Json$Encode.bool(val));};
   var maximumTrackTintColor = function (val) {    return A2($NativeUi.property,"maximumTrackTintColor",$Json$Encode.string(val));};
   var minimumTrackTintColor = function (val) {    return A2($NativeUi.property,"minimumTrackTintColor",$Json$Encode.string(val));};
   var maximumValue = function (val) {    return A2($NativeUi.property,"maximumValue",$Json$Encode.$float(val));};
   var minimumValue = function (val) {    return A2($NativeUi.property,"minimumValue",$Json$Encode.$float(val));};
   var step = function (val) {    return A2($NativeUi.property,"step",$Json$Encode.$float(val));};
   var sliderValue = function (val) {    return A2($NativeUi.property,"sliderValue",$Json$Encode.$float(val));};
   var momentary = function (val) {    return A2($NativeUi.property,"momentary",$Json$Encode.bool(val));};
   var tintColor = function (val) {    return A2($NativeUi.property,"tintColor",$Json$Encode.string(val));};
   var selectedIndex = function (val) {    return A2($NativeUi.property,"selectedIndex",$Json$Encode.$float(val));};
   var zoomScale = function (val) {    return A2($NativeUi.property,"zoomScale",$Json$Encode.$float(val));};
   var removeClippedSubviews = function (val) {    return A2($NativeUi.property,"removeClippedSubviews",$Json$Encode.bool(val));};
   var snapToAlignment = function (val) {
      var stringValue = function () {
         var _p10 = val;
         switch (_p10.ctor)
         {case "ScrollViewSnapToAlignmentStart": return "start";
            case "ScrollViewSnapToAlignmentCenter": return "center";
            default: return "end";}
      }();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"snapToAlignment",jsonValue);
   };
   var ScrollViewSnapToAlignmentEnd = {ctor: "ScrollViewSnapToAlignmentEnd"};
   var ScrollViewSnapToAlignmentCenter = {ctor: "ScrollViewSnapToAlignmentCenter"};
   var ScrollViewSnapToAlignmentStart = {ctor: "ScrollViewSnapToAlignmentStart"};
   var snapToInterval = function (val) {    return A2($NativeUi.property,"snapToInterval",$Json$Encode.$float(val));};
   var showsVerticalScrollIndicator = function (val) {    return A2($NativeUi.property,"showsVerticalScrollIndicator",$Json$Encode.bool(val));};
   var showsHorizontalScrollIndicator = function (val) {    return A2($NativeUi.property,"showsHorizontalScrollIndicator",$Json$Encode.bool(val));};
   var sendMomentumEvents = function (val) {    return A2($NativeUi.property,"sendMomentumEvents",$Json$Encode.bool(val));};
   var scrollsToTop = function (val) {    return A2($NativeUi.property,"scrollsToTop",$Json$Encode.bool(val));};
   var scrollEventThrottle = function (val) {    return A2($NativeUi.property,"scrollEventThrottle",$Json$Encode.$float(val));};
   var pagingEnabled = function (val) {    return A2($NativeUi.property,"pagingEnabled",$Json$Encode.bool(val));};
   var minimumZoomScale = function (val) {    return A2($NativeUi.property,"minimumZoomScale",$Json$Encode.$float(val));};
   var maximumZoomScale = function (val) {    return A2($NativeUi.property,"maximumZoomScale",$Json$Encode.$float(val));};
   var keyboardShouldPersistTaps = function (val) {    return A2($NativeUi.property,"keyboardShouldPersistTaps",$Json$Encode.bool(val));};
   var keyboardDismissMode = function (val) {
      var stringValue = function () {
         var _p11 = val;
         switch (_p11.ctor)
         {case "ScrollViewKeyboardDismissModeNone": return "none";
            case "ScrollViewKeyboardDismissModeInteractive": return "interactive";
            default: return "on-drag";}
      }();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"keyboardDismissMode",jsonValue);
   };
   var ScrollViewKeyboardDismissModeOnDrag = {ctor: "ScrollViewKeyboardDismissModeOnDrag"};
   var ScrollViewKeyboardDismissModeInteractive = {ctor: "ScrollViewKeyboardDismissModeInteractive"};
   var ScrollViewKeyboardDismissModeNone = {ctor: "ScrollViewKeyboardDismissModeNone"};
   var canCancelContentTouches = function (val) {    return A2($NativeUi.property,"canCancelContentTouches",$Json$Encode.bool(val));};
   var directionalLockEnabled = function (val) {    return A2($NativeUi.property,"directionalLockEnabled",$Json$Encode.bool(val));};
   var indicatorStyle = function (val) {
      var stringValue = function () {
         var _p12 = val;
         switch (_p12.ctor)
         {case "ScrollViewIndicatorStyleDefault": return "default";
            case "ScrollViewIndicatorStyleBlack": return "black";
            default: return "white";}
      }();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"indicatorStyle",jsonValue);
   };
   var ScrollViewIndicatorStyleWhite = {ctor: "ScrollViewIndicatorStyleWhite"};
   var ScrollViewIndicatorStyleBlack = {ctor: "ScrollViewIndicatorStyleBlack"};
   var ScrollViewIndicatorStyleDefault = {ctor: "ScrollViewIndicatorStyleDefault"};
   var horizontal = function (val) {    return A2($NativeUi.property,"horizontal",$Json$Encode.bool(val));};
   var centerContent = function (val) {    return A2($NativeUi.property,"centerContent",$Json$Encode.bool(val));};
   var alwaysBounceVertical = function (val) {    return A2($NativeUi.property,"alwaysBounceVertical",$Json$Encode.bool(val));};
   var alwaysBounceHorizontal = function (val) {    return A2($NativeUi.property,"alwaysBounceHorizontal",$Json$Encode.bool(val));};
   var bouncesZoom = function (val) {    return A2($NativeUi.property,"bouncesZoom",$Json$Encode.bool(val));};
   var bounces = function (val) {    return A2($NativeUi.property,"bounces",$Json$Encode.bool(val));};
   var automaticallyAdjustContentInsets = function (val) {    return A2($NativeUi.property,"automaticallyAdjustContentInsets",$Json$Encode.bool(val));};
   var title = function (val) {    return A2($NativeUi.property,"title",$Json$Encode.string(val));};
   var refreshing = function (val) {    return A2($NativeUi.property,"refreshing",$Json$Encode.bool(val));};
   var trackTintColor = function (val) {    return A2($NativeUi.property,"trackTintColor",$Json$Encode.string(val));};
   var progressTintColor = function (val) {    return A2($NativeUi.property,"progressTintColor",$Json$Encode.string(val));};
   var progressViewStyle = function (val) {
      var stringValue = function () {
         var _p13 = val;
      ...
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"progressViewStyle",jsonValue);
   };
   var ProgressViewProgressViewStyleBar = {ctor: "ProgressViewProgressViewStyleBar"};
   var ProgressViewProgressViewStyleDefault = {ctor: "ProgressViewProgressViewStyleDefault"};
   var progress = function (val) {    return A2($NativeUi.property,"progress",$Json$Encode.$float(val));};
   var prompt = function (val) {    return A2($NativeUi.property,"prompt",$Json$Encode.string(val));};
   var mode = function (val) {
      var stringValue = function () {    var _p14 = val;if (_p14.ctor === "PickerModeDialog") {    return "dialog";} else {    return "dropdown";}}();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"mode",jsonValue);
   };
   var PickerModeDropdown = {ctor: "PickerModeDropdown"};
   var PickerModeDialog = {ctor: "PickerModeDialog"};
   var enabled = function (val) {    return A2($NativeUi.property,"enabled",$Json$Encode.bool(val));};
   var active = function (val) {    return A2($NativeUi.property,"active",$Json$Encode.bool(val));};
   var minDelta = function (val) {    return A2($NativeUi.property,"minDelta",$Json$Encode.$float(val));};
   var maxDelta = function (val) {    return A2($NativeUi.property,"maxDelta",$Json$Encode.$float(val));};
   var mapType = function (val) {
      var stringValue = function () {
         var _p15 = val;
         switch (_p15.ctor)
         {case "MapViewMapTypeStandard": return "standard";
            case "MapViewMapTypeSatellite": return "satellite";
            default: return "hybrid";}
      }();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"mapType",jsonValue);
   };
   var MapViewMapTypeHybrid = {ctor: "MapViewMapTypeHybrid"};
   var MapViewMapTypeSatellite = {ctor: "MapViewMapTypeSatellite"};
   var MapViewMapTypeStandard = {ctor: "MapViewMapTypeStandard"};
   var scrollEnabled = function (val) {    return A2($NativeUi.property,"scrollEnabled",$Json$Encode.bool(val));};
   var pitchEnabled = function (val) {    return A2($NativeUi.property,"pitchEnabled",$Json$Encode.bool(val));};
   var rotateEnabled = function (val) {    return A2($NativeUi.property,"rotateEnabled",$Json$Encode.bool(val));};
   var zoomEnabled = function (val) {    return A2($NativeUi.property,"zoomEnabled",$Json$Encode.bool(val));};
   var showsCompass = function (val) {    return A2($NativeUi.property,"showsCompass",$Json$Encode.bool(val));};
   var showsPointsOfInterest = function (val) {    return A2($NativeUi.property,"showsPointsOfInterest",$Json$Encode.bool(val));};
   var followUserLocation = function (val) {    return A2($NativeUi.property,"followUserLocation",$Json$Encode.bool(val));};
   var showsUserLocation = function (val) {    return A2($NativeUi.property,"showsUserLocation",$Json$Encode.bool(val));};
   var size = function (val) {
      var stringValue = function () {    var _p16 = val;if (_p16.ctor === "ActivityIndicatorSizeSmall") {    return "small";} else {    return "large";}}();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"size",jsonValue);
   };
   var ActivityIndicatorSizeLarge = {ctor: "ActivityIndicatorSizeLarge"};
   var ActivityIndicatorSizeSmall = {ctor: "ActivityIndicatorSizeSmall"};
   var hidesWhenStopped = function (val) {    return A2($NativeUi.property,"hidesWhenStopped",$Json$Encode.bool(val));};
   var color = function (val) {    return A2($NativeUi.property,"color",$Json$Encode.string(val));};
   var animating = function (val) {    return A2($NativeUi.property,"animating",$Json$Encode.bool(val));};
   var resizeMode = function (val) {
      var stringValue = function () {
         var _p17 = val;
         switch (_p17.ctor)
         {case "ImageResizeModeCover": return "cover";
            case "ImageResizeModeContain": return "contain";
            default: return "stretch";}
      }();
      var jsonValue = $Json$Encode.string(stringValue);
      return A2($NativeUi.property,"resizeMode",jsonValue);
   };
   var ImageResizeModeStretch = {ctor: "ImageResizeModeStretch"};
   var ImageResizeModeContain = {ctor: "ImageResizeModeContain"};
   var ImageResizeModeCover = {ctor: "ImageResizeModeCover"};
   var accessibilityLabel = function (val) {    return A2($NativeUi.property,"accessibilityLabel",$Json$Encode.string(val));};
   var accessible = function (val) {    return A2($NativeUi.property,"accessible",$Json$Encode.bool(val));};
   var defaultSource = function (uri) {
      return A2($NativeUi.property,"defaultSource",$Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "uri",_1: $Json$Encode.string(uri)}])));
   };
   var source = function (uri) {
      return A2($NativeUi.property,"source",$Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "uri",_1: $Json$Encode.string(uri)}])));
   };
   var allowFontScaling = function (val) {    return A2($NativeUi.property,"allowFontScaling",$Json$Encode.bool(val));};
   var testID = function (val) {    return A2($NativeUi.property,"testID",$Json$Encode.string(val));};
   var suppressHighlighting = function (val) {    return A2($NativeUi.property,"suppressHighlighting",$Json$Encode.bool(val));};
   var numberOfLines = function (val) {    return A2($NativeUi.property,"numberOfLines",$Json$Encode.$float(val));};
   return _elm.NativeUi.Properties.values = {_op: _op
                                            ...
                                            ,ImageResizeModeCover: ImageResizeModeCover
                                            ,ImageResizeModeContain: ImageResizeModeContain
                                            ,ImageResizeModeStretch: ImageResizeModeStretch
                                            ,resizeMode: resizeMode
                                            ,animating: animating
                                            ,color: color
                                            ,hidesWhenStopped: hidesWhenStopped
                                            ,ActivityIndicatorSizeSmall: ActivityIndicatorSizeSmall
                                            ,ActivityIndicatorSizeLarge: ActivityIndicatorSizeLarge
                                            ,size: size
                                            ...
                                            ,MapViewMapTypeStandard: MapViewMapTypeStandard
                                            ,MapViewMapTypeSatellite: MapViewMapTypeSatellite
                                            ,MapViewMapTypeHybrid: MapViewMapTypeHybrid
                                            ,mapType: mapType
                                            ,maxDelta: maxDelta
                                            ,minDelta: minDelta
                                            ,active: active
                                            ,enabled: enabled
                                            ,PickerModeDialog: PickerModeDialog
                                            ,PickerModeDropdown: PickerModeDropdown
                                            ,mode: mode
                                            ,prompt: prompt
                                            ,progress: progress
                                            ,ProgressViewProgressViewStyleDefault: ProgressViewProgressViewStyleDefault
                                            ,ProgressViewProgressViewStyleBar: ProgressViewProgressViewStyleBar
                                            ...
                                            ,ScrollViewIndicatorStyleDefault: ScrollViewIndicatorStyleDefault
                                            ,ScrollViewIndicatorStyleBlack: ScrollViewIndicatorStyleBlack
                                            ,ScrollViewIndicatorStyleWhite: ScrollViewIndicatorStyleWhite
                                            ,indicatorStyle: indicatorStyle
                                            ,directionalLockEnabled: directionalLockEnabled
                                            ,canCancelContentTouches: canCancelContentTouches
                                            ,ScrollViewKeyboardDismissModeNone: ScrollViewKeyboardDismissModeNone
                                            ,ScrollViewKeyboardDismissModeInteractive: ScrollViewKeyboardDismissModeInteractive
                                            ,ScrollViewKeyboardDismissModeOnDrag: ScrollViewKeyboardDismissModeOnDrag
                                            ...
                                            ,sendMomentumEvents: sendMomentumEvents
                                            ,showsHorizontalScrollIndicator: showsHorizontalScrollIndicator
                                            ,showsVerticalScrollIndicator: showsVerticalScrollIndicator
                                            ,snapToInterval: snapToInterval
                                            ,ScrollViewSnapToAlignmentStart: ScrollViewSnapToAlignmentStart
                                            ,ScrollViewSnapToAlignmentCenter: ScrollViewSnapToAlignmentCenter
                                            ,ScrollViewSnapToAlignmentEnd: ScrollViewSnapToAlignmentEnd
                                            ...
                                            ,StatusBarBarStyleDefault: StatusBarBarStyleDefault
                                            ,StatusBarBarStyleLightContent: StatusBarBarStyleLightContent
                                            ,barStyle: barStyle
                                            ,networkActivityIndicatorVisible: networkActivityIndicatorVisible
                                            ,StatusBarShowHideTransitionFade: StatusBarShowHideTransitionFade
                                            ,StatusBarShowHideTransitionSlide: StatusBarShowHideTransitionSlide
                                            ,showHideTransition: showHideTransition
                                            ,TextInputAutoCapitalizeNone: TextInputAutoCapitalizeNone
                                            ,TextInputAutoCapitalizeSentences: TextInputAutoCapitalizeSentences
                                            ,TextInputAutoCapitalizeWords: TextInputAutoCapitalizeWords
                                            ,TextInputAutoCapitalizeCharacters: TextInputAutoCapitalizeCharacters
                                            ,autoCapitalize: autoCapitalize
                                            ,autoCorrect: autoCorrect
                                            ,autoFocus: autoFocus
                                            ,editable: editable
                                            ,TextInputKeyboardTypeDefault: TextInputKeyboardTypeDefault
                                            ,TextInputKeyboardTypeEmailAddress: TextInputKeyboardTypeEmailAddress
                                            ,TextInputKeyboardTypeNumeric: TextInputKeyboardTypeNumeric
                                            ,TextInputKeyboardTypePhonePad: TextInputKeyboardTypePhonePad
                                            ,TextInputKeyboardTypeAsciiCapable: TextInputKeyboardTypeAsciiCapable
                                            ,TextInputKeyboardTypeNumbersAndPunctuation: TextInputKeyboardTypeNumbersAndPunctuation
                                            ,TextInputKeyboardTypeUrl: TextInputKeyboardTypeUrl
                                            ,TextInputKeyboardTypeNumberPad: TextInputKeyboardTypeNumberPad
                                            ,TextInputKeyboardTypeNamePhonePad: TextInputKeyboardTypeNamePhonePad
                                            ,TextInputKeyboardTypeDecimalPad: TextInputKeyboardTypeDecimalPad
                                            ,TextInputKeyboardTypeTwitter: TextInputKeyboardTypeTwitter
                                            ,TextInputKeyboardTypeWebSearch: TextInputKeyboardTypeWebSearch
                                            ,keyboardType: keyboardType
                                            ,TextInputKeyboardAppearanceDefault: TextInputKeyboardAppearanceDefault
                                            ,TextInputKeyboardAppearanceLight: TextInputKeyboardAppearanceLight
                                            ,TextInputKeyboardAppearanceDark: TextInputKeyboardAppearanceDark
                                            ,keyboardAppearance: keyboardAppearance
                                            ,TextInputReturnKeyTypeDefault: TextInputReturnKeyTypeDefault
                                            ,TextInputReturnKeyTypeGo: TextInputReturnKeyTypeGo
                                            ,TextInputReturnKeyTypeGoogle: TextInputReturnKeyTypeGoogle
                                            ,TextInputReturnKeyTypeJoin: TextInputReturnKeyTypeJoin
                                            ,TextInputReturnKeyTypeNext: TextInputReturnKeyTypeNext
                                            ,TextInputReturnKeyTypeRoute: TextInputReturnKeyTypeRoute
                                            ,TextInputReturnKeyTypeSearch: TextInputReturnKeyTypeSearch
                                            ,TextInputReturnKeyTypeSend: TextInputReturnKeyTypeSend
                                            ,TextInputReturnKeyTypeYahoo: TextInputReturnKeyTypeYahoo
                                            ,TextInputReturnKeyTypeDone: TextInputReturnKeyTypeDone
                                            ,TextInputReturnKeyTypeEmergencyCall: TextInputReturnKeyTypeEmergencyCall
                                            ...
                                            ,TextInputClearButtonModeNever: TextInputClearButtonModeNever
                                            ,TextInputClearButtonModeWhileEditing: TextInputClearButtonModeWhileEditing
                                            ,TextInputClearButtonModeUnlessEditing: TextInputClearButtonModeUnlessEditing
                                            ,TextInputClearButtonModeAlways: TextInputClearButtonModeAlways
                                            ...
                                            ,rtl: rtl
                                            ,ViewAccessibilityLiveRegionNone: ViewAccessibilityLiveRegionNone
                                            ,ViewAccessibilityLiveRegionPolite: ViewAccessibilityLiveRegionPolite
                                            ,ViewAccessibilityLiveRegionAssertive: ViewAccessibilityLiveRegionAssertive
                                            ,accessibilityLiveRegion: accessibilityLiveRegion
                                            ,ViewImportantForAccessibilityAuto: ViewImportantForAccessibilityAuto
                                            ,ViewImportantForAccessibilityYes: ViewImportantForAccessibilityYes
                                            ,ViewImportantForAccessibilityNo: ViewImportantForAccessibilityNo
                                            ,ViewImportantForAccessibilityNoHideDescendants: ViewImportantForAccessibilityNoHideDescendants
                                            ,importantForAccessibility: importantForAccessibility
                                            ,ViewPointerEventsBoxNone: ViewPointerEventsBoxNone
                                            ,ViewPointerEventsNone: ViewPointerEventsNone
                                            ,ViewPointerEventsBoxOnly: ViewPointerEventsBoxOnly
                                            ,ViewPointerEventsAuto: ViewPointerEventsAuto
...
Elm.Main.make = function (_elm) {
       ...
       $Maybe = Elm.Maybe.make(_elm),
       $NativeUi = Elm.NativeUi.make(_elm),
       $NativeUi$Elements = Elm.NativeUi.Elements.make(_elm),
       $NativeUi$Handlers = Elm.NativeUi.Handlers.make(_elm),
       $NativeUi$NativeApp = Elm.NativeUi.NativeApp.make(_elm),
       $NativeUi$Properties = Elm.NativeUi.Properties.make(_elm),
       $NativeUi$Style = Elm.NativeUi.Style.make(_elm),
       $Result = Elm.Result.make(_elm),
       $Signal = Elm.Signal.make(_elm);
       var _op = {};
       var button = F4(function (address,action,color,content) {
                       return A2($NativeUi$Elements.text
                                ,_U.list([$NativeUi.style(_U.list([$NativeUi$Style.color("white")
                                         ...
                                         ,A2($NativeUi$Handlers.onPress,address,action)])
       ...
       var Increment100 = {ctor: "Increment100"};
       var Increment = {ctor: "Increment"};
       var view = F2(function (address,count) {
                     return A2($NativeUi$Elements.view
                              ,_U.list([$NativeUi.style(_U.list([$NativeUi$Style.alignItems("center")]))])
                              ,_U.list([A2($NativeUi$Elements.text
                                          ,_U.list([$NativeUi.style(_U.list([$NativeUi$Style.marginBottom(30)]))])
                                          ,_U.list([$NativeUi.string("This is written in Elm :)")]))
                                       ,A2($NativeUi$Elements.image
                                          ,_U.list([$NativeUi.style(_U.list([$NativeUi$Style.height(64)
                                                                            ,$NativeUi$Style.width(64)
                                                                            ,$NativeUi$Style.marginBottom(30)]))
                                                   ,$NativeUi$Properties.source("https://raw.githubusercontent.com/futurice/spiceprogram/master/assets/img/logo/chilicorn_no_text-128.png")])
                                          ,_U.list([]))
                                       ,A2($NativeUi$Elements.text
                                       ...
                                       ,A2($NativeUi$Elements.view
                                          ,_U.list([$NativeUi.style(_U.list([$NativeUi$Style.width(175)
                                                                            ,$NativeUi$Style.flexDirection("row")
                                                                            ,$NativeUi$Style.justifyContent("space-between")]))])
                                          ,_U.list([A4(button,address,Decrement,"#d33","-1")
                                                   ,A4(button,address,Increment,"#3d3","+1")
                                                   ,A4(button,address,Increment100,"#3d3","+100")]))]));
                  });
       var model = 9000;
